var app = (function () {
      ...
      m.$on("click", e[4]),
      {
        c() {
          (t = w("header")),
            ...
            (l = x()),
            (u = w("h1")),
            (u.textContent = "Guilty Gear Heardle"),
            (c = x()),
            (d = w("div")),
            Q(h.$$.fragment),
            (f = x()),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a>, and <a href="https://heardle-kpop.glitch.me/" title="Heardle">K-Pop Heardle</a> but for Guilty Gear songs.</p> \n\n<p class="mb-3">Each Guilty Gear Heardle is randomly chosen from Guilty Gear\'s Entire discography.</p> \n\n\n\n <p class="mb-3">Have questions/run into bugs? @Deyvonnn on twitter! </p>  \n\n\n\n <p class="mb-3">Want to make your own Heardle? Check out the <a href="https://glitch.com/edit/#!/ffxiv-heardle?path=README.md">README</a>  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://glitch.com/">Glitch</a>. <a href="https://omakase.studio" title="Studio Omakase">Served omakase / お任せ</a>. '),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
      ...
      (u = new Bt({})),
      {
        c() {
          (n = w("p")),
            (s = w("p")),
            (n.textContent =
              "Have questions/run into bugs? @zenosenjoyer on twitter!"),
            (r = x()),
            (s = w("p")),
            // (s.innerHTML =
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Guilty Gear song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Guilty Gear Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Guilty Gear Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _(
          "You didn't get today's Guilty Gear Heardle. Better luck tomorrow! 💎"
        );
      },
      m(e, t) {
        g(e, n, t);
    ...
    return (
      ...
      [
        ...
        () => {
          ...
          let e = "Guilty Gear Heardle #" + (s.id + 1),
            t = "";
          a
          ...
          let o =
            ...
            "\n\n" 
            // +
            // "@pledis_17 #Guilty Gear" +
            // "\n\n" +
            // "https://ffxiv-heardle.glitch.me/"
          ;
          if (
            !navigator.share ||
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Guilty Gear Heardle"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the Guilty Gear song from the intro in as few tries as possible"
          ),
